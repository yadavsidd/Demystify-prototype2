...
import type { DocumentAnalysis, DocumentGuide, SimplifiedForm, DocumentTranslation } from '../types';

// FIX: Per coding guidelines, API key must be read directly from `process.env.API_KEY`.
// Removed fallback and warning, assuming the environment variable is always set.
